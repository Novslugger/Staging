...
$('#energy_save_btn').live('click', function () {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/Energy/Save_energy_data',
            data: items,
            success: function (data) {
                    ...
                    $.each(data, function (index, value) {
                        ...
                        $(document).ready(function () {
                            ...
                            function () {
                                ...
                                //    $(this).find('input').addClass('changed');
                                //});
                                //$(this).parents('tr').find('td').each(function () {
                                //    $(this).find('input').css({ 'background-color': '#DFD8D1' });
                                //});
                            });
                        });
                    });
...
function save_dailymg() {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/Energy/Save_DailyMG/',
            data: items,
            success: function (data) {
...
$('#consumables_save_btn').live('click', function () {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/SFP/Save_SFPConsumables',
            data: items,
            success: function (data) {
...
$('#sfp_targets_save_btn').live('click', function () {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/SFP/Save_SFPTargets',
            data: items,
            success: function (data) {
...
$('#forecast_save_btn').live('click', function () {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/SFP/Save_SFPForecast',
            data: items,
            success: function (data) {
...
$('#buckets_save_btn').live('click', function () {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/SFP/Save_Buckets',
            data: items,
            success: function (data) {
    ...
    if (crew_ != "") {
        ...
        if (items.length != 0) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                url: afserverpath + '/SFP/Save_CrewDefault',
                data: items,
                success: function (data) {
                            ...
                            success: function (result) {
                                ...
                                if (items.length != 0) {
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: 'json',
                                        type: 'POST',
                                        url: afserverpath + '/SFP/Save_SFP_ManPower',
                                        data: items,
                                        success: function (data) {
