                            ...
                            success: function (data) {
                                ...
                                if (items.length != 0) {
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: 'json',
                                        type: 'POST',
                                        url: afserverpath + '/Operations/Assign_ManPower/',
                                        data: items,
                                        success: function (data) {
...
function load_fsfe_matte_tapping() {
    ...
    $('#fsfe_controlrm_mattetapper_table td').remove();
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                $('#fsfe_controlrm_mattetapper_table tr:last').after('<tr><td>'
                    ...
                    + value.Launder + '</td><td>' + value.Mtapper
                    + '</td><td>' + zerovalue(value.MatteVolume) + '</td><td>&nbsp;<a class="delete_regcrew" href="#" onclick="delete_mtapping('
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                $('#fsfe_tapact_slagtap_table tr:last').after('<tr><td>'
                    + i + '</td><td>' + formatDate(value.SlagTap_StartTime) + '</td><td>'
                    + formatDate(value.SlagTap_EndTime) + '</td><td>'
                    + value.LaddlePitNo + '</td><td>'
                    + value.SlagTender + '</td><td>&nbsp;<a class="delete_regcrew" href="#" onclick="delete_stapping('
...
$("#DialogSlagTappingEdit_Select #add_slag_laddlepit").live('keyup', function () {
    ...
    if (!$.isNumeric(pitnum)) {
        ...
        $("#DialogSlagTappingEdit_Select #stender_emp").val("ok");
        load_assign_slagtender("#DialogSlagTappingEdit_Select", parseInt(pitnum) + 8);
    }
});
...
function load_assign_launder(dialogname) {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $(dialogname + ' #mttaper1_emp').text('Not Assigned Yet.');
            $(dialogname + ' #mttaper2_emp').text('Not Assigned Yet.');
...
function Stapping_add() {
    ...
    stapping_check("#DialogSlagTapping_Select", sdate, shr, smin, edate, ehr, emin, 'add');

}

function stapping_check(dialogname, sdate, shr, smin, edate, ehr, emin, mode) {
    ...
    if (checktime == true && slagladdlepit_ != '') {

        if (mode == 'add') {

            save_stapping(sdate_, edate_);

        } else if (mode == 'edit') {

            edit_stapping("#DialogSlagTappingEdit_Select", sdate_, edate_);
        }
...
function Mtapping_edit() {
    ...
    mtapping_check("#DialogMatteTappingEdit_Select", sdate, shr, smin, edate, ehr, emin, 'edit');
...
function Stapping_edit() {
    ...
    stapping_check("#DialogSlagTappingEdit_Select", sdate, shr, smin, edate, ehr, emin, 'edit');

}

function mtapping_check(dialogname, sdate, shr, smin, edate, ehr, emin, mode) {
    ...
    if (checktime == true && launder1_ != '' && launder2_ != '') {
        ...
        if (mode == 'add') {
            ...
            save_mtapping(dialogname, sdate_, edate_);
...
function save_mtapping(dialogname, start_date_tap, end_date_tap) {
...
//Edit Matte Tapping
function edit_mtapping(dialogname, start_date_tap, end_date_tap) {
...
function edit_stapping(dialogname, start_date_tap, end_date_tap) {
    ...
    if (crew_ != "") {
        ...
        if (items.length != 0) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                type: 'POST',
                url: afserverpath + '/Operations/Assign_CrewDefault/',
                data: items,
                success: function (data) {
                    alert('Crew Default now saved.');
                }
                ...
                success: function (data) {
                    ...
                    if (items.length != 0) {
                        ...
                        $.ajax({
                            ...
                            dataType: 'json',
                            type: 'POST',
                            url: afserverpath + '/Operations/Save_Equipment_Issues/',
                            data: items,
                            success: function (data) {
        ...
        success: function (data) {
            ...
            $.each(data, function (index, value) {
                ...
                $('#table_fsfe_dustline_inspections th[id*="param_' + value.FSFE_ParamId + '"]').after('<td id="param_ ">'
                    ...
                    + value.FSFE_DustlineInspection_Id + ');return false;"><u>Edit</u></a>&nbsp;</td>');
...
$('#fsfe_targets_save_btn').live('click', function () {
    ...
    if (items.length != 0) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            type: 'POST',
            url: afserverpath + '/Operations/Save_FSFETargets',
            data: items,
            success: function (data) {
